...
#define LM_RALT LM(_FNM, MOD_RALT)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_65_ansi(
		KC_ESC,  KC_1,     KC_2,     KC_3,   KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_MINS,  KC_EQL,  KC_BSPC, KC_GRV,  \
		KC_TAB,  KC_Q,     KC_W,     KC_E,   KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_LBRC,  KC_RBRC, KC_BSLS, KC_DEL,  \
		LT_BSPC, KC_A,     KC_S,     KC_D,   KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,           KC_ENT,  KC_PGUP, \
		KC_LSPO, KC_Z,     KC_X,     KC_C,   KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSPC,           KC_UP,   KC_PGDN, \
		KC_LCTL, KC_LGUI,  KC_LALT,                   KC_SPC,                             LM_RALT, MO(_FNC), KC_RCTL,  KC_LEFT, KC_DOWN, KC_RGHT  \
	),
	[_COLEMAK] = LAYOUT_65_ansi(
		...
		_______, KC_X,     KC_C,     KC_D,   KC_V,    KC_Z,    KC_M,    KC_H,    _______, _______, _______,  _______,           _______, _______, \
	...
	[_FNM]    = LAYOUT_65_ansi(
		...
		_______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,           _______, _______, \
		_______, _______,  _______,                   _______,                            _V_V_V_, _______,  _______,  _______, _______, _______  \
	),
	[_NAV]    = LAYOUT_65_ansi(
		KC_NLCK, KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_P7,   KC_P8,   KC_P9,   KC_PAST,  KC_PMNS,  KC_PPLS, KC_DEL,  _______, \
		_______, KC_PGUP,  KC_HOME, KC_UP,   KC_END,  _______, _______, KC_P4,   KC_P5,   KC_P6,   KC_PSLS,  _______,  KC_SLCK, KC_INS,  KC_INS,  \
		_V_V_V_, KC_PGDN,  KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_PMNS,  _______,           KC_PENT, KC_HOME, \
		_______, _______,  _______, _______, _______, _______, KC_P0,   KC_P0,   KC_P0,   KC_PDOT, KC_PPLS,  _______,           _______, KC_END,  \
		_______, _______,  _______,                   KC_BSPC,                            _______, _______,  _______,  _______, _______, _______  \
	),
	[_FNC]    = LAYOUT_65_ansi(
		KC_GRV,  KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,  _______, KC_ASTG, \
		_______, RGB_MOD,  RGB_SPI, RGB_HUI, RGB_SAI, RGB_VAI, _______, MAS_MGT, MAS_BLU, MAS_WHT, KC_PSCR,  RGB_RMOD, RGB_MOD, _______, KC_MUTE, \
		_______, RGB_RMOD, RGB_SPD, RGB_HUD, RGB_SAD, RGB_VAD, _______, MAS_RED, MAS_KEY, MAS_CYN, MAS_PRP,  _______,           EEP_RST, KC_MPRV, \
		_______, RGB_TOG,  _______, _______, REEPROM, REBOOT,  TG_NKRO, MAS_YEL, MAS_GRN, MAS_CRM, _______,  _______,           KC_VOLU, KC_MNXT, \
		_______, _______,  _______,                   TG_CLMK,                            _______, _V_V_V_,  _______,  RGB_SPD, KC_VOLD, RGB_SPI  \
	),
	/*
...
void rgb_matrix_indicators_user(void)
{
    ...
    if (layer_state_cmp(layer_state, _COLEMAK)) {
        rgb_matrix_set_color(35, 0xAA, 0x00, 0x00);
    }
	...
	if (!g_suspend_state && rgb_matrix_config.enable) {
		...
		case _NAV:
			...
			rgb_matrix_set_color(57,  0x00, 0x00, 0xFF);
			...
			rgb_matrix_set_color(35, 0xFF, 0x00, 0x00); // backspace
			break;
		...
		case _FNC: {
			...
			rgb_matrix_set_color(24, 0xFF, 0x00, 0x00); // KC_MUTE
			rgb_matrix_set_color(25, 0xFF, 0x40, 0x00); // KC_MPRV
			rgb_matrix_set_color(32, 0xFF, 0x40, 0x00);

			if (this_led & (1 << !autoshift_enabled)) {
				rgb_matrix_set_color(23, 0xFF, 0x00, 0x00); // KC_ASTG
			} else {
			...
			rgb_matrix_set_color(0, 0xF0, 0x00, 0xFF); //MAS_MGT
			rgb_matrix_set_color(26, 0x00, 0x02, 0xFF); //MAS_BLU
			...
			rgb_matrix_set_color(27, 0xFF, 0xFF, 0xFF); //MAS_WHT
		}
		break;
		}
	}
