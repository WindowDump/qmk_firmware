...
[_GLOWER] = LAYOUT( // Gamer Lower
  KC_ESC,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_RBRC, KC_UNDS, KC_PLUS, KC_TILD, KC_PIPE, KC_DEL,
  _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LPRN, KC_MINS, KC_EQL,  KC_GRV,  KC_BSLS, KC_F12,
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  _______, _______, _______, _______, V_V_V_V,     KC_BSPC,      KC_ADJS, KC_HOME, KC_PGDN, KC_PGUP, KC_END
),

[_LOWER] = LAYOUT(
  KC_GRV,  KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_LBRC, KC_RBRC, KC_UNDS, KC_PLUS, KC_TILD, KC_PIPE, KC_DEL,
...
[_ADJUST] = LAYOUT(
  RESET,   _______, _______, KC_FBVU, KC_FBPL, KC_VOLU, _______, TG_HNDS, TG_GAM2, _______, _______, KC_PSCR,
