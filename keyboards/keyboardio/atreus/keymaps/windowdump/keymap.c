...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_HANDSDOWN] = LAYOUT(
    KC_W,    KC_G,    KC_H,    KC_M,    KC_K,                      KC_Q,    KC_C,    KC_U,    KC_J,    KC_QUOT,
    KC_LG_R, KC_LA_S, KC_LC_N, KC_LS_T, KC_F,                      KC_Y,    KC_RS_A, KC_RC_E, KC_RA_O, KC_RG_I,
    KC_X,    KC_B,    KC_L,    KC_D,    KC_V,    _______, _______, KC_Z,    KC_P,    KC_COMM, KC_DOT,  KC_SLSH,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),

  [_HANDSDOWN_MODS] = LAYOUT(
    _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______,
    KC_R,    KC_S,    KC_N,    KC_T,    _______,                   _______, KC_A,    KC_E,    KC_O,    KC_I,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),
...
const uint16_t PROGMEM wg_combo[] = {KC_W, KC_G, COMBO_END};
const uint16_t PROGMEM xb_combo[] = {KC_X, KC_B, COMBO_END};
const uint16_t PROGMEM oi_hr_combo[] = {KC_RA_O, KC_RG_I, COMBO_END};
const uint16_t PROGMEM jq_combo[] = {KC_J, KC_QUOT, COMBO_END};
...
combo_t key_combos[] = {
  ...
  [WG_ESC] = COMBO(wg_combo, KC_ESC),
  [XB_TAB] = COMBO(xb_combo, KC_TAB),
  [OI_HR_SCLN] = COMBO(oi_hr_combo, KC_SCLN),
  [JQ_DEL] = COMBO(jq_combo, KC_DEL)
};
