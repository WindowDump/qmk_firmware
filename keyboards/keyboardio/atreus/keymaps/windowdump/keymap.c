...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_HANDSDOWN_MODS] = LAYOUT_wrapper(
    _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______,
    ________HANDS_DOWN_ALT_L2_NO_HR_MODS_______,                   ________HANDS_DOWN_ALT_L3_NO_HR_MODS_______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),
  ...
  [_ADJUST] = LAYOUT_wrapper(
    ...
    _________________ADJUST_L3_________________, A(KC_PSCR), KC_PSCR, _________________ADJUST_R3 _________________,
